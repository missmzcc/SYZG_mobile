    ...
    <div class="easyui-navpanel">
        ...
        <div style="margin:50px 0 0;text-align:left;">
            ...
            <div style="padding:20px">
                <a href="javascript:void(0)" onclick="qry_warn();" class="easyui-linkbutton c6" style="width:100%;height:33px;">告警信息</a>                
            </div>
    ...
    <div id="p2" class="easyui-navpanel">
        <header>
            <div class="m-toolbar">
                ...
                <div class="m-left">
					<a href="javascript:void(0)"  onclick="" class="easyui-linkbutton m-back l-btn l-btn-small l-btn-plain l-btn-outline" data-options="plain:true,outline:true,back:true" group="" id="A2"><span class="l-btn-left"><span class="l-btn-text">重查</span></span></a>
				</div>
            </div>
        </header>
        <table id="dg">  
        <thead>  
            <tr>  
                ...
                <th data-options="field:'poi',width:80,align:'right'">地点</th>  
            </tr>
        </thead>  
    </table>
    </div>
...
<script src="warning_query.js"></script>
