<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="history_lose.aspx.cs" Inherits="_01.history_lose" %>
...
<body>
    ...
    <div id="p1" class="easyui-navpanel">
        ...
        <div style="margin:15px 0 0;text-align:left;">
            <div style ="padding-left:25px">
                ...
                <div>
                    <p>开始时间</p>
                    <input id="beginTime" class="easyui-datetimebox" style="width: 50%" data-options="value:'<%=DateTime.Now.AddDays(-1).ToString("yyyy-MM-dd HH:mm:ss") %>',editable: true, required: true, showSeconds: false">
                </div>
                 <div>
                    <p>结束时间</p>
                    <input id="endTime" class="easyui-datetimebox" style="width:50%" data-options="value:'<%=DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") %>',editable: true, required: true, showSeconds: false">
                </div>
            </div>
    ...
    <div id="p2" class="easyui-navpanel">
        ...
        <thead>  
            <tr>  
                <th data-options="field:'a',width:'40px'">失联时刻</th>  
                <th data-options="field:'nMin',width:'20px',align:'right'">时长</th>  
...
<script src="history_lose.js"></script>
